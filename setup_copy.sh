...
# Setup inicial do ambiente para o site (VERSAO COPY)
set -e
...
log "Ativando o start_copy.sh para iniciar o site..."
sudo chmod +x "$PWD/start_copy.sh"
log "Executando start_copy.sh..."
"$PWD/start_copy.sh"
log "================================================"
