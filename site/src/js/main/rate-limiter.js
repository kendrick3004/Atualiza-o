...
const RateLimiter = (function() {
    ...
    // Configurações
    const CONFIG = {
        MAX_REQUESTS: 100,         // Aumentado para 100 para suportar compactação de muitos arquivos
        TIME_WINDOW: 5000,         // Janela de tempo em milissegundos (5 segundos)
        BLOCK_DURATION: 10000,     // Reduzido para 10 segundos para ser menos punitivo
    ...
    function redirectToBlockPage() {
        ...
        const blockPageUrl = protocol + '//' + host + '/maintenance/429.html';
